...
fn add_msg(tags: &str, comment: &str, snippet: &str, writer: &Box<impl Writer>, stdin: &mut std::process::ChildStdin) {
...
pub fn cheatsheet(writer: &Box<impl Writer>, stdin: &mut std::process::ChildStdin) {
    add_msg(
        "cheatsheets",
